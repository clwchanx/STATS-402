...
print(model_main_cv)
```
With a slightly lower RMSE and MAE values, also a higher Rsquared value, We consider the model with interaction effect as the better model for our predictions